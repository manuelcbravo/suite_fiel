    ...
    public function permisos(): array
    {
        return match ($this) {
            self::Administrador => [
                ...
                Permiso::GestionGestionar,
                Permiso::AgendaGestionar,
                Permiso::InvitacionesGestionar,
                Permiso::NotasGestionar,
                Permiso::ReportesVer,
                Permiso::ReporteAgenda,
                Permiso::ReporteDirectorio,
                Permiso::ReporteGestion,
                Permiso::CapacitacionVer,
                Permiso::TableroEjecutivo,
                Permiso::TableroGestion,
                Permiso::TableroFinanciero,
                Permiso::SeguridadGestionar,
            ],
        };
    }
